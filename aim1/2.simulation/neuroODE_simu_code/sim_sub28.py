...
import scipy.io
mat = scipy.io.loadmat('sim/sim28.mat')
...
save("simu_results/sim28.npy" ,result)
# result_df = pd.DataFrame(result)
# result_df.columns = ['tp', 'acc', 'Euclidean_dist', 'spec_dist', 'edit', 'netsmile']
# result_df.to_csv(f"neuro_results/thre{thre}/sim_sub28.csv")
