...
parser.add_argument('--ratio', type=float, default=0.5, help='ratio for adding extra feature')
...
for i in range(len(data_cv)):
    ...
    ######2. create model
    model = GCN_fusion6(nfeat = num_features,
                nfeat_ext= 5,
                nhid = args.nhid,
                nclass=2,
