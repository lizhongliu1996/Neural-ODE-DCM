...
def main():
    ...
    parser.add_argument('--lambdaL1', type=float, default=0.001, help = "lambda for l1 loss.")
    ...
    for epoch in range(1, args.epochs+1):
        ...
        train(args, model, train_loader, optimizer, args.lambdaL1)
    ...
    save_path = 'loss_nopretrain_ext_full.png'
    draw_loss_graph(loss_list, save_path)
    
    os.makedirs(f"result/finetune_seed{args.seed}" , exist_ok=True)
    filepath = f"result/finetune_seed{args.seed}"+"/"+"nopretrain_ext_result.pkl"
